...
//    FILE *test_fd = fopen("/home/wangming/gpac-0.8.0/bin/gcc/test.aac","ab+");
//    fputc(val, test_fd);
//    fclose(test_fd);
//    FILE *test_fd = fopen("/home/wangming/gpac-0.8.0/bin/gcc/test.hvc","ab+");
//    fputc(val, test_fd);
//    fclose(test_fd);
//    printf("%x ",val);
...
//            FILE *test_fd = fopen("/home/wangming/gpac-0.8.0/bin/gcc/test.aac","ab+");
//            fwrite(data,nbBytes,1,test_fd);
//            fclose(test_fd);
//            FILE *test_fd = fopen("/home/wangming/gpac-0.8.0/bin/gcc/test.hvc","ab+");
//            fwrite(data,nbBytes,1,test_fd);
//            printf("nbBytes : %d \t",nbBytes);
//            fclose(test_fd);
