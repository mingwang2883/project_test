...
//  printf("start with rtsp\n");
  set_packet_sizes(1000, 200*1024);
}
...
//      printf("m_is_first_packet is true\n");
...
//    printf("m_num_frames_used_so_far > 0\n");
    // Send the packet:
...
//    printf("m_out_buf->reset_packet_start\n");
  }
...
//    printf("num_frame_bytes_to_use > 0\n");
